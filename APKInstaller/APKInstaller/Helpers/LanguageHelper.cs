...
namespace APKInstaller.Helpers
{
    public static class LanguageHelper
    {
        ...
        private static int FindIndexFromSupportLanguageCodes(string language)
            => SupportLanguageCodes.FindIndex(code => code.ToLowerInvariant().Contains(language.ToLowerInvariant()));
        ...
        public static string GetCurrentLanguage()
        {
            ...
            foreach (string language in languages)
            {
                ...
                if (temp != -1) { return SupportLanguages[temp]; }
            }
        ...
        public static string GetPrimaryLanguage()
        {
            ...
            int temp = FindIndexFromSupportLanguageCodes(language);
            return temp == -1 ? FallbackLanguage : SupportLanguages[temp];
        }
    }
}
